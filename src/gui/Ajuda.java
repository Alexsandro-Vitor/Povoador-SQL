...
public class Ajuda extends JFrame {
	...
	public String[] ajuda = {
		...
		+ "*" + GeradorChave.nomeComando + GeradorChave.inteiro + "(inicio): Gera um valor que começa em inicio e é incrementado em cada inserção"
		+ " gerada. Deve  ser usado para gerar as chaves caso a tabela use uma chave inteira.\n\n"
		+ "*" + GeradorChave.nomeComando + GeradorChave.varchar + "(inicio): Igual ao " + GeradorChave.nomeComando + GeradorChave.inteiro
